...
let dynamicProjectsStore = new Map([
    [
        1,
        {
            id: 1,
...
export class ProjectsService {
    ...
    async loadRawProjects() {
        ...
        return Array.from(dynamicProjectsStore.values());
    }
    /** Calculate actual procurement spend linked to projects */
    async enrichSpendFromProcurement(projects) {
        try {
            ...
            const poSpendByProject = new Map();
