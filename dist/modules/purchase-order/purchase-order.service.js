...
export class PurchaseOrderService {
    ...
    async getPurchaseOrders(params) {
        ...
        const cGuids = orders.map(o => o.CGuid).filter(Boolean);
        let itemsMap = {};
        if (cGuids.length > 0) {
    ...
    async updatePurchaseOrder(id, data, updatedById) {
        ...
        const result = await prisma.$transaction(async (tx) => {
            ...
            if (data.CustCode !== undefined)
                updatePayload.CustCode = data.CustCode;
            if (data.CustName !== undefined)
                updatePayload.CustName = data.CustName;
            if (data.PostDate !== undefined)
                updatePayload.PostDate = docDate;
            if (data.ReceiptDate !== undefined)
                updatePayload.ReceiptDate = data.ReceiptDate ? new Date(data.ReceiptDate) : null;
            if (data.PODate !== undefined)
                updatePayload.PODate = data.PODate ? new Date(data.PODate) : null;
            if (data.Remarks !== undefined)
                updatePayload.Remarks = data.Remarks;
            if (data.Branch_id !== undefined)
                updatePayload.Branch_id = data.Branch_id;
            if (data.OrderCode !== undefined)
                updatePayload.OrderCode = data.OrderCode;
            if (data.RequestedNo !== undefined)
                updatePayload.RequestedNo = data.RequestedNo;
            if (data.relation_from !== undefined)
                updatePayload.relation_from = data.relation_from;
            if (data.DiscPrcnt !== undefined)
                updatePayload.DiscPrcnt = data.DiscPrcnt;
            if (data.Freight !== undefined)
                updatePayload.Freight = data.Freight;
            if (data.Department !== undefined)
                updatePayload.Department = data.Department;
            if (data.ExpenseType !== undefined)
                updatePayload.ExpenseType = data.ExpenseType;
            if (data.Expense_type !== undefined)
                updatePayload.ExpenseType = data.Expense_type;
            if (data.RequestType !== undefined)
                updatePayload.RequestType = data.RequestType;
            if (data.TypeRequest !== undefined)
                updatePayload.TypeRequest = data.TypeRequest;
            if (data.TypePayment !== undefined)
                updatePayload.TypePayment = data.TypePayment;
            if (data.Status !== undefined)
                updatePayload.Status = data.Status;
            if (data.AprStatus !== undefined)
                updatePayload.AprStatus = data.AprStatus;
            if (data.AprRemark !== undefined)
                updatePayload.AprRemark = data.AprRemark;
            if (data.Pr_ID !== undefined)
                updatePayload.Pr_ID = String(data.Pr_ID);
            if (data.Pq_ID !== undefined)
                updatePayload.Pq_ID = String(data.Pq_ID);
            if (data.PurchaseRequestId !== undefined)
                updatePayload.PurchaseRequestId = data.PurchaseRequestId;
            if (data.PurchaseQuotationId !== undefined)
                updatePayload.PurchaseQuotationId = data.PurchaseQuotationId;
            if (data.items) {
