...
export class UsersService {
    ...
    async updateUser(id, data) {
        ...
        if (data.active !== undefined)
            updateData.Active = data.active ? 'Y' : 'N';
        if (data.isAdmin !== undefined)
            updateData.IsAdmin = data.isAdmin ? 'Y' : 'N';
        ...
        if (data.isPriceEdit !== undefined)
            updateData.IsPriceEdit = data.isPriceEdit ? 'Y' : 'N';
        if (data.isAllowLineDiscount !== undefined)
            updateData.isAllowLineDiscount = data.isAllowLineDiscount ? 'Y' : 'N';
        if (data.isFrieghtAdd !== undefined)
            updateData.IsFrieghtAdd = data.isFrieghtAdd ? 'Y' : 'N';
        if (data.dim1 !== undefined)
            updateData.DIM1 = data.dim1;
        if (data.dim2 !== undefined)
            updateData.DIM2 = data.dim2;
        if (data.dim3 !== undefined)
            updateData.DIM3 = data.dim3;
        if (data.dim4 !== undefined)
            updateData.DIM4 = data.dim4;
        if (data.cashAcct !== undefined)
            updateData.CashAcct = data.cashAcct;
        if (data.checkAcct !== undefined)
            updateData.CheckAcct = data.checkAcct;
        if (data.tigoPesa !== undefined)
            updateData.TigoPesa = data.tigoPesa;
        if (data.mpesa !== undefined)
            updateData.Mpesa = data.mpesa;
        if (data.airtelMoney !== undefined)
            updateData.AirtelMoney = data.airtelMoney;
        if (data.bankDeposit !== undefined)
            updateData.BankDeposit = data.bankDeposit;
        if (data.userPermission !== undefined)
            updateData.user_permission = data.userPermission;
